...
from actor_network import ContinuousActorNetwork
from critic_network import ContinuousCriticNetwork

"""
Agent Class
------------
Constructs, saves, and loads actor and critic networks. 
Chooses policy or action. 
...
class Agent:
    def __init__(self, n_actions, input_dims, gamma=0.99, alpha=3e-4,
                 gae_lambda=0.95, policy_clip=0.2, batch_size=64, n_epochs=10, entropy_coefficient=0.001):
        self.gamma = gamma
